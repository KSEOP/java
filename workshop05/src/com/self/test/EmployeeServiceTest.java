...
public class EmployeeServiceTest {
	public static void main(String[] args) {
		...
		ArrayList<Employee> retEs1 = service.findEmployeeByDeptNo(10);
		...
		ArrayList<Employee> e1 = service.findEmployeeByTech("JAVA");
		for(Employee e : e1) {
			if(e==null) continue;
			System.out.println(e);
		}
		...
		ArrayList<Employee> emps = service.getAnnualSalaryMoreThan(4000000.0);
		for(Employee e : emps) {
			if(e==null) continue;
			System.out.println(e);
		}
